<template>
  <div>
    <a-modal :visible="props.visible"
      ...
      <a-form ref="formRef" name="AccountRecordInfoForm" class="ant-advanced-search-form" :model="formState" @finish="onFinish"
        ...
        <a-row :gutter="24">
          ...
          <a-col :span="12">
            <a-form-item name="avliDate" label="有效期">
              <a-input v-model:value="formState.avliDate" placeholder="请填写有效期"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          ...
          <a-col :span="12">
            <a-form-item name="account" label="账号">
              <a-input v-model:value="formState.account" placeholder="请填写账号"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item name="isSend" label="是否发送提醒">
              <a-input v-model:value="formState.isSend" placeholder="请填写是否发送提醒"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
...
} from "@/api/alex_miaosha_finance/accountRecordInfo/accountRecordInfoTs";
