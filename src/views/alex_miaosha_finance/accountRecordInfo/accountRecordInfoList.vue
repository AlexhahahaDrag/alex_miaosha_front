         ...
         <a-row :gutter="24">
            ...
            <a-col :span="6">
              <a-form-item name="avliDate" label="有效期">
                <a-input v-model:value="searchInfo.avliDate" placeholder="有效期" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="6">
              <a-form-item name="amount" label="金额">
                <a-input v-model:value="searchInfo.amount" placeholder="金额" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="6">
         ...
         <a-row :gutter="24">
            <a-col :span="6">
              <a-form-item name="isSend" label="是否发送提醒">
                <a-input v-model:value="searchInfo.isSend" placeholder="是否发送提醒" allow-clear />
              </a-form-item>
            </a-col>
          </a-row>
            <a-row :gutter="24">
...
import { getAccountRecordInfoPage, deleteAccountRecordInfo } from "@/api/alex_miaosha_finance/accountRecordInfo/accountRecordInfoTs";
