  ...
  <div class="card-management">
    ...
    <div class="card-list">
      <div style="display: flex; justify-content: start; align-items: center">
        <h2>我的消费卡</h2>
        <a-button type="primary" style="margin-left: 10px" @click="handleRecharge('recharge')">
          新增消费记录
        </a-button>
      </div>
      <a-row :gutter="24">
    ...
    <div class="transaction-records">
      ...
      <div class="record-header">
        <span v-if="selectedCardId">
          当前查看: {{ getSelectedCardName() }} 的交易记录
        </span>
        <a-button v-if="selectedCardId" type="link" @click="clearCardSelection">
          查看全部记录
        </a-button>
      </div>
      <a-table :columns="columns" :data-source="transactions" :pagination="paginationInfo" @change="handleTableChange">
