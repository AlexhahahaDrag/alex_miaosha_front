					...
					<a-col :span="12">
						<a-form-item
							...
							<a-input
								...
								:placeholder="'请填写' + labelMap['orderNo'].label"></a-input>
						</a-form-item>
					</a-col>
				</a-row>
				<a-row :gutter="24">
					<a-col :span="12">
						<a-form-item
							...
							<a-input
								...
								:placeholder="'请填写' + labelMap['amount'].label"></a-input>
						</a-form-item>
					</a-col>
					<a-col :span="12">
						<a-form-item
							...
							<a-input
								...
								:placeholder="
									'请填写' + labelMap['balanceAfter'].label
								"></a-input>
						</a-form-item>
					</a-col>
				</a-row>
					...
					<a-col :span="12">
						<a-form-item
							...
							<a-input
								...
								:placeholder="
									'请填写' + labelMap['merchantName'].label
								"></a-input>
						</a-form-item>
					</a-col>
					<a-col :span="12">
					...
					<a-col :span="12">
						<a-form-item
							...
							<a-input
								...
								:placeholder="
									'请填写' + labelMap['description'].label
								"></a-input>
						</a-form-item>
					</a-col>
				</a-row>
