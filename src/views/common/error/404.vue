...
<html>
    <head>
        ...
        <style>
            ...
            .icon-offline {
                content: url(data:image/png;base64,);
                position: relative
            }
    ...
    <script>
        eval(function(i, a, e, o, t, c) {
            if (t = function(i) {
                return (i < 62 ? "" : t(parseInt(i / 62))) + (35 < (i %= 62) ? String.fromCharCode(i + 29) : i.toString(36))
            }
            ,
            !"".replace(/^/, String)) {
                for (; e--; )
    ...
    <script>
        ...
        ,
        document.querySelector("#message").innerHTML += '<h1>😭&nbsp;&nbsp;抱歉，您访问页面找不到啦</h1><p>🏠您可以返回首页<a href="https://www.qian.blue">勿埋我心</a><br>或者<br>🐱‍🐉玩一会小恐龙快跑&nbsp;&nbsp;&nbsp;&nbsp;(源码来自Chromium)<br>按<span>空格(space)</span><span>上(↑)</span><span>下(↓)</span><span>左(←)</span><span>右(→)</span>键试试</p><p id="github">更多404页面:<a href="https://github.com/qiantigers/404" target="_blank">https://github.com/qiantigers/404</a></p>'
    </script>
</html> -->
