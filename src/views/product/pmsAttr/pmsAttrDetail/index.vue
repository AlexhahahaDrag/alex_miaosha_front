        ...
        <a-row :gutter='24'>
          ...
          <a-col :span='12'>
            <a-form-item :name="labelMap['searchType'].name" :label="labelMap['searchType'].label">
              <a-input v-model:value='formState.searchType' :placeholder="'请填写' + labelMap['searchType'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
          ...
          <a-col :span='12'>
            <a-form-item :name="labelMap['valueSelect'].name" :label="labelMap['valueSelect'].label">
              <a-input v-model:value='formState.valueSelect' :placeholder="'请填写' + labelMap['valueSelect'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['attrType'].name" :label="labelMap['attrType'].label">
              <a-input v-model:value='formState.attrType' :placeholder="'请填写' + labelMap['attrType'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['enable'].name" :label="labelMap['enable'].label">
              <a-input v-model:value='formState.enable' :placeholder="'请填写' + labelMap['enable'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['catelogId'].name" :label="labelMap['catelogId'].label">
              <a-input v-model:value='formState.catelogId' :placeholder="'请填写' + labelMap['catelogId'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['showDesc'].name" :label="labelMap['showDesc'].label">
              <a-input v-model:value='formState.showDesc' :placeholder="'请填写' + labelMap['showDesc'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
