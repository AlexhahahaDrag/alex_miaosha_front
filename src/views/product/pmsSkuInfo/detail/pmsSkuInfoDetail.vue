<template>
  <div>
    <a-modal :visible="props.visible"
      ...
      <a-form ref="formRef" name="PmsSkuInfoForm" class="ant-advanced-search-form" :model="formState" @finish="onFinish"
        @finishFailed="onFinishFailed" :rules="rulesRef" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item name="spuId" label="spuId">
              <a-input v-model:value="formState.spuId" placeholder="请填写spuId"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item name="skuName" label="sku名称">
              <a-input v-model:value="formState.skuName" placeholder="请填写sku名称"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item name="skuDesc" label="sku介绍描述">
              <a-input v-model:value="formState.skuDesc" placeholder="请填写sku介绍描述"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item name="catalogId" label="所属分类id">
              <a-input v-model:value="formState.catalogId" placeholder="请填写所属分类id"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item name="brandId" label="品牌id">
              <a-input v-model:value="formState.brandId" placeholder="请填写品牌id"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item name="skuDefaultImg" label="默认图片">
              <a-input v-model:value="formState.skuDefaultImg" placeholder="请填写默认图片"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item name="skuTitle" label="标题">
              <a-input v-model:value="formState.skuTitle" placeholder="请填写标题"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item name="skuSubtitle" label="副标题">
              <a-input v-model:value="formState.skuSubtitle" placeholder="请填写副标题"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item name="price" label="价格">
              <a-input v-model:value="formState.price" placeholder="请填写价格"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item name="saleCount" label="销量">
              <a-input v-model:value="formState.saleCount" placeholder="请填写销量"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
