<template>
  <div>
    <a-modal :open='props.open'
      ...
      <a-form ref='formRef' name='ShopStockForm' class='ant-advanced-search-form' :model='formState' @finish='onFinish'
        ...
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['costAmount'].name" :label="labelMap['costAmount'].label">
              <a-input v-model:value='formState.costAmount' :placeholder="'请填写' + labelMap['costAmount'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
        ...
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['category'].name" :label="labelMap['category'].label">
              <a-select ref="select" v-model:value="formState.category" mode="combobox" :placeholder="'请输入' + labelMap['category'].label"
          ...
          <a-col :span='12'>
            <a-form-item :name="labelMap['purchasePlace'].name" :label="labelMap['purchasePlace'].label">
              <a-select ref="select" v-model:value="formState.purchasePlace" mode="combobox" :placeholder="'请输入' + labelMap['purchasePlace'].label"
...
import { ShopStockDetail } from './shopStockDetailTs';
import {
  getShopStockDetail,
  addOrEditShopStock,
...
import { ModelInfo } from '../shopStockListTs';
