						...
						<a-col :span="8">
							...
							>
								<a-input
									...
									:placeholder="'请选择' + labelMap['stockId'].label"
									allow-clear
								/>
							</a-form-item>
						</a-col>
						<a-col :span="8">
							...
							>
								<a-input
									...
									:placeholder="'请选择' + labelMap['attrCode'].label"
									allow-clear
								/>
							</a-form-item>
						</a-col>
						...
						<a-col :span="8">
							...
							>
								<a-input
									...
									:placeholder="'请选择' + labelMap['attrValue'].label"
									allow-clear
								/>
							</a-form-item>
						</a-col>
...
import { pagination, columns } from './shopStockAttrsListTs';
import {
