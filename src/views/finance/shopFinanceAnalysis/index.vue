    ...
    <div class="content">
      <div style="background-color: #ececec; padding: 10px">
        ...
        <a-row :gutter="16" style="padding-top: 10px">
          <div class="mainGrid">
            <div class="div1">
              <ShopPieChart title="当月收入分析" height="100%" width="100%" :data="pieShopData" :tooltip="tooltip">
              </ShopPieChart>
            </div>
            <div class="div2">
              <ShopPieChart title="当月支出分析" height="100%" width="100%" :data="piePayWayData" :tooltip="tooltip">
              </ShopPieChart>
            </div>
          </div>
        </a-row>
        <a-row :gutter="16" style="padding-top: 10px">
          <div class="mainGrid">
            <div class="div1">
              <ShopBarChart height="100%" width="100%" title="日消费" :data="dayData" :config="dayConfig">
              </ShopBarChart>
            </div>
            <div class="div2">
              <ShopBarChart height="100%" width="100%" title="月消费" :data="monthData" :config="monthConfig">
              </ShopBarChart>
            </div>
          </div>
        </a-row>
...
import { ShopFinanceDetail } from "@/views/finance/shopFinance/shopFinanceDetail/shopFinanceDetailTs";
import { ItemInfo } from "./shopAnalysis";
import dayjs, { Dayjs } from "dayjs";
import locale from "ant-design-vue/es/date-picker/locale/zh_CN";
import { barItem } from "./chart/shopBar";
