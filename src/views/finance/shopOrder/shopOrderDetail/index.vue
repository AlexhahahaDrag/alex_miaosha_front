<template>
  <div>
    <a-modal :open='props.open'
      ...
      <a-form ref='formRef' name='ShopOrderForm' class='ant-advanced-search-form' :model='formState' @finish='onFinish'
        @finishFailed='onFinishFailed' :rules='rulesRef' :label-col='labelCol' :wrapper-col='wrapperCol'>
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['saleOrderCode'].name" :label="labelMap['saleOrderCode'].label">
              <a-input v-model:value='formState.saleOrderCode' :placeholder="'请填写' + labelMap['saleOrderCode'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['saleOrderName'].name" :label="labelMap['saleOrderName'].label">
              <a-input v-model:value='formState.saleOrderName' :placeholder="'请填写' + labelMap['saleOrderName'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
          ...
          <a-col :span='12'>
            <a-form-item :name="labelMap['isValid'].name" :label="labelMap['isValid'].label">
              <a-select ref="select" v-model:value="formState.isValid" mode="combobox" :placeholder="'请输入' + labelMap['isValid'].label"
        ...
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['saleDate'].name" :label="labelMap['saleDate'].label">
              <a-input v-model:value='formState.saleDate' :placeholder="'请填写' + labelMap['saleDate'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['description'].name" :label="labelMap['description'].label">
              <a-input v-model:value='formState.description' :placeholder="'请填写' + labelMap['description'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['payWay'].name" :label="labelMap['payWay'].label">
              <a-input v-model:value='formState.payWay' :placeholder="'请填写' + labelMap['payWay'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['saleCount'].name" :label="labelMap['saleCount'].label">
              <a-input v-model:value='formState.saleCount' :placeholder="'请填写' + labelMap['saleCount'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
...
import { ShopOrderDetail } from './shopOrderDetailTs';
import {
  getShopOrderDetail,
  addOrEditShopOrder,
...
import { ModelInfo } from '../shopOrderListTs';
