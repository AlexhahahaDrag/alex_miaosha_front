<template>
  <div>
    <a-modal :visible='props.visible'
      ...
      <a-form ref='formRef' name='OrgInfoForm' class='ant-advanced-search-form' :model='formState' @finish='onFinish'
        ...
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['orgCode'].name" :label="labelMap['orgCode'].label">
              <a-input v-model:value='formState.orgCode' :placeholder="'请填写' + labelMap['orgCode'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['orgName'].name" :label="labelMap['orgName'].label">
              <a-input v-model:value='formState.orgName' :placeholder="'请填写' + labelMap['orgName'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
...
import { OrgInfoDetail } from './orgInfoDetailTs';
import {
  getOrgInfoDetail,
  addOrEditOrgInfo,
...
import { ModelInfo } from '../orgInfoListTs';
