<template>
  <div>
    <a-modal :visible='props.visible'
      ...
      <a-form ref='formRef' name='RoleInfoForm' class='ant-advanced-search-form' :model='formState' @finish='onFinish'
        ...
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['roleCode'].name" :label="labelMap['roleCode'].label">
              <a-input v-model:value='formState.roleCode' :placeholder="'请填写' + labelMap['roleCode'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['roleName'].name" :label="labelMap['roleName'].label">
              <a-input v-model:value='formState.roleName' :placeholder="'请填写' + labelMap['roleName'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
...
import { RoleInfoDetail } from './roleInfoDetailTs';
import {
  getRoleInfoDetail,
  addOrEditRoleInfo,
...
import { ModelInfo } from '../roleInfoListTs';
