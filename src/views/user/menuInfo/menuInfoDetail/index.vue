<template>
  <div>
    <a-modal :open='props.open' :width="props.modelInfo && props.modelInfo.width ? props.modelInfo.width : '1000px'"
      ...
      <a-form ref='formRef' name='MenuInfoForm' class='ant-advanced-search-form' :model='formState' @finish='onFinish'
        ...
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['name'].name" :label="labelMap['name'].label">
              <a-input v-model:value='formState.name' :placeholder="'请填写' + labelMap['name'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['path'].name" :label="labelMap['path'].label">
              <a-input v-model:value='formState.path' :placeholder="'请填写' + labelMap['path'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['title'].name" :label="labelMap['title'].label">
              <a-input v-model:value='formState.title' :placeholder="'请填写' + labelMap['title'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['component'].name" :label="labelMap['component'].label">
              <a-input v-model:value='formState.component' :placeholder="'请填写' + labelMap['component'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['redirect'].name" :label="labelMap['redirect'].label">
              <a-input v-model:value='formState.redirect' :placeholder="'请填写' + labelMap['redirect'].label"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span='12'>
            <a-form-item :name="labelMap['icon'].name" :label="labelMap['icon'].label">
              <a-input v-model:value='formState.icon' :placeholder="'请填写' + labelMap['icon'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
          ...
          <a-col :span='12'>
            <a-form-item :name="labelMap['parentId'].name" :label="labelMap['parentId'].label">
              <a-input v-model:value='formState.parentId' :placeholder="'请填写' + labelMap['parentId'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter='24'>
        ...
        <a-row :gutter='24'>
          <a-col :span='12'>
            <a-form-item :name="labelMap['orderBy'].name" :label="labelMap['orderBy'].label">
              <a-input v-model:value='formState.orderBy' :placeholder="'请填写' + labelMap['orderBy'].label"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
...
import { ModelInfo } from '../menuInfoListTs';
